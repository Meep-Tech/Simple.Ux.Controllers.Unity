...
using Simple.Ux.Controllers.Unity.Utility;
...
namespace Simple.Ux.Controllers.Unity {
  ...
  /// </summary>
  public class ViewController : MonoBehaviour, IElementContainerController {
  ...
  public bool IsPersistent
    ...
    public void InitializeFor(View model) {
      ...
      if(!string.IsNullOrWhiteSpace(model.MainTitle.Tooltip)) {
        TooltipController tooltip = _mainViewTitleText.gameObject.AddComponent<TooltipController>();
    ...
    public void ResetTitle() {
      _mainViewTitleText.text = "+" + Data?.MainTitle.Text ?? "TITLESS";
    }
